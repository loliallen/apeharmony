    ...
    return (
        <>
            <Box
                ...
                >
                    <Typography variant={sm ? "h4" : "h3"}>Collection:</Typography>
                    <Select
                        variant="outlined"
            ...
            >
                {paggination.max > 0 && <ButtonGroup>
                    <StyledButton variant="contained" disabled={paggination.current == 0}
                                  onClick={() => paggination.setPage(p => p - 1)}>Prev</StyledButton>
                    <StyledButton variant="contained">{paggination.current + 1}</StyledButton>
                    <StyledButton variant="contained" disabled={!(paggination.current < paggination.max)}
                                  onClick={() => paggination.setPage(p => p + 1)}>Next</StyledButton>
                </ButtonGroup>}
            </Box>
        </>
    )
